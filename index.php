...
<?php include "include/profit.php";?>
 <section class="banner_wrap">
  ...
  $total_users = mysqli_num_rows($run_total_users) + 85600;
...
Finally our aim is to utilize our expertise and knowledge which will benefit our clients and the users of our services.
        ...
        <div class="col-lg-6">
        <iframe width="280" height="167" src="https://www.youtube.com/embed/Yb6825iv0Vk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
</div>
<br>
...
<coingecko-coin-compare-chart-widget  coin-ids="bitcoin,ethereum,eos,ripple,litecoin" currency="usd" locale="en"></coingecko-coin-compare-chart-widget>
	...
	<div class="latestInner">
			...
			<ul>
                ...
                <?php
                                ...
                                while($row_deposit = mysqli_fetch_array($run_deposit)){
                                  $username = $row_deposit['first_name'];
                                  $usernamew = $row_deposit['last_name'];
                                    ...
                                    echo"
                                    <li>
                                    <span class='span1'>$username $usernamew</span>
                                    <span>$$amount2</span>
		...
		<div class="latest-row latest-row3">
                ...
                <?php
                                $get_deposit1 = "select * from withdraw_request where verified = 1 order by id DESC limit 0,5  ";
                                $run_deposit1 = mysqli_query($connect,$get_deposit1);
                                while($row_deposit1 = mysqli_fetch_array($run_deposit1)){
                                  $username1 = $row_deposit1['first_name'];
                            
                                          $usernamek = $row_deposit1['last_name'];

                                    $amount21 = $row_deposit1['amount'];

                              
                             
                                    echo"
                                    <li>
                                    <span class='span1'>$username1 $usernamek</span>
                                    <span>$$amount21</span>
                        <i><img src='images/48.gif' style='margin-top: 10px;'></i>
                                </li>
                                    ";
...
<br><br>
<h3 class="zoomIn wow">Our <strong>Certificate</strong></h3>
<div class="container">
  <div class="row">
    <div class="col-lg-12">
    <a href="images/cert1.pdf"> <img src="images/cert1.png" style="width:30%; margin-left:35%;" alt=""></a>
    </div>
  </div>
</div>
        <br> <br>
